...
public class VentanaSalida extends JFrame {
   ...
   public VentanaSalida(ArrayList<Particion> particiones, int tamMemFija, int Time) {
   ...
   public void iniciarComponentes(ArrayList<Particion> particiones, int tamMemFija, int Time) {     
        
        contenedor = new JPanel();
        contenedor.setLayout(null);
        contenedor.setBackground(new java.awt.Color(135,200,222));
        
        panelCPU = new JPanel();
        panelCPU.setLayout(null);
        panelCPU.setBackground(new java.awt.Color(255,191,122));
        ...
        contenedor2.setBackground(new java.awt.Color(175,200,222));
   ...
   public void dibujarMemoria (ArrayList<Particion> particiones, ArrayList<Particion> memoriaVariable, int tamMemFija, int Time) {
       JTextPane encabezado = new JTextPane();
       encabezado.setContentType("text/html");
       encabezado.setText("<html><body><p style='margin: 2px; text-align: center; font-size: 20; font: arial; color:#665754; '><b>Tiempo "+ (Integer.toString(Time))  + " </b></p></body></html>");
       ...
       encabezado.setEditable(false);
        ...
        if (tamMemFija > 0) { 
            panel.setBounds((10+(Time*210)), 10, 200, ((particiones.size()*85)+40));
        }else{
       ...
       if (tamMemFija > 0) { 
           for (Particion lista3 : particiones){
            ...
            etiqueta.setText("<html><body><p style='margin: 2px; text-align: center; font: serif; font-size: 12pt;color:#665754;'><b> Particion nro: " + (Integer.toString(lista3.NroPart)) + "</b>" + 
            ...
            if (lista3.libre) {
               etiqueta.setBackground(new java.awt.Color(136,228,188));
            }else{
               etiqueta.setBackground(Color.getHSBColor(120, 33, 60));
            }
            etiqueta.setEditable(false);
            
            panel.add(etiqueta);
            contenedor.add(panel);
            contenedor.setPreferredSize(new Dimension(((Time*210)+220),((particiones.size()*85)+45)));
           }  
           ...
           for (Particion lista3 : memoriaVariable){
                ...
                JTextPane etiqueta = new JTextPane();
                etiqueta.setContentType("text/html");
                etiqueta.setText("<html><body><p style='margin: 2px; text-align: center; font: serif; font-size: 12pt;color:#665754;'> <br/> Proceso Cargado: " + (lista3.ProCargado) + 
                       " <br/> Tamaño de particion: " + (Integer.toString(lista3.TamPart))+
                       " <br/> Estado: " + estado + "\n \n" + "</p></body></html>");
                etiqueta.setBounds(5, ejey, 190, 80);
                etiqueta.setOpaque(true);
   ...
   public void dibujarCPU(int Time, int PID){
       ...
       tituloCPU.setForeground(Color.gray);
   ...
   public void mostrarSalida(int Time, float tr, float te, int cantCPU){
    ...
    scrollPane.setBounds(0,0,398,(screenSize.height-65));
        
    scrollPane2 = new JScrollPane(contenedor2);
    scrollPane2.setBounds(400, 0, (screenSize.width-400), (screenSize.height-65));
    ...
    barra.setBackground(new java.awt.Color(135,200,122));
    ...
    titulo1.setText("<html><body><p style='text-align:center; font-size: 8; margin-top: 1px; font: sans-serif; color:#ffffff; '><b>ASIGNACIONES DE MEMORIA</b></p></body></html>");
    ...
    titulo10.setBackground(new java.awt.Color(1,131,41));
    barra.add(titulo10);
    ...
    titulo2.setText("<html><body><p style='text-align:left; font-size: 8; margin-top: 1px; font: sans-seriff; color:#ffffff; '><b>DIAGRAMAS DE GANTT DE LOS RECURSOS</b></p></body></html>");
    titulo2.setBounds(520, 25, 310, 20);
   ...
   //private javax.swing.JLabel cerrar;
    ...
    private JTextPane dibujarBloques(int Time, int PID, int anterior) {
       ...
       if (PID ==0){            
            cuadro.setText("<html><body><p style='margin: 2px; 	text-align:center; margin-top:10px; font-size: 12; font: arial; color:#665754; '>Ociosa </p></body></html>");
            cuadro.setOpaque(false);
            cuadro.setBounds((50+(Time*55)), 50, 50, 50);
        }else{
            switch (PID){
               case 1:cuadro.setBackground(new java.awt.Color(217,195,206)); break;
               case 2:cuadro.setBackground(Color.getHSBColor(120, 33, 60)); break;
               case 3:cuadro.setBackground(new java.awt.Color(150,147,218)); break;
               case 4:cuadro.setBackground(new java.awt.Color(135,200,122)); break;
               case 5:cuadro.setBackground(new java.awt.Color(242,147,239)); break;
               case 6:cuadro.setBackground(new java.awt.Color(242,147,149)); break;
               case 7:cuadro.setBackground(new java.awt.Color(147,148,242)); break;
               case 8:cuadro.setBackground(new java.awt.Color(105,180,103)); break;
               case 9:cuadro.setBackground(new java.awt.Color(150,184,189)); break;
            }
            ...
            cuadro.setText("<html><body><p style='margin: 2px; 	text-align:center; margin-top:10px; font-size: 20; font: arial; color:#665754; '><b>"+ (Integer.toString(PID))  + " </b></p></body></html>");
